        ...
        <div class="footer">    
            <div class="inner_footer">
                    <div class="footer_items">
                        ...
                        <ul>
                            <li><a href ="#">Home</a></li>
                             <li><a href="Telefonia.html">About us</a></li>
                            <li> <a href="Interneti.html">Gallery</a></li>
                            <li><a href="Help&Support.html">Contact</a></li>
                ...
                <div class="footer_items">
                    ...
                    <ul>
                        ...
                        <li><address><a href="mailto:FrrokMotion@gmail.com">FrrokMotion@hgmail.com</a></address></li>
                    </ul>
                </div>
                <div class="footer_items">
                    <h2>Social</h2>
